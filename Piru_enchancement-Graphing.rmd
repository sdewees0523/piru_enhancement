...
hear_fit_2019 <- survfit(hear_surv_obj_2019 ~ native_cover, data = hear_survival_2019)

# Optional plot
ggsurvplot(hear_fit_2019, data = hear_survival_2019,
           conf.int = TRUE,
           risk.table = F,
           pval = TRUE)
...
saap_fit_2019 <- survfit(saap_surv_obj_2019 ~ native_cover, data = saap_survival_2019)

# Optional plot
ggsurvplot(saap_fit_2019, data = saap_survival_2019,
           conf.int = TRUE,
           risk.table = F,
           pval = TRUE)
