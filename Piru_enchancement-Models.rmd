...
summary(aov(mafacover~ MAFA_removal, data = mafa_cover))
TukeyHSD(aov(mafacover~ MAFA_removal, data = mafa_cover))
#$MAFA_removal
#               diff       lwr      upr     p adj
...
summary(aov(mafacover~ MAFA_removal, data = mafa_cover %>% filter(year=="2018")))
TukeyHSD(aov(mafacover~ MAFA_removal, data = mafa_cover %>% filter(year=="2018")))
#$MAFA_removal
#               diff       lwr      upr     p adj
