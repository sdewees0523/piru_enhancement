...
nnmod_environ <- nnmod %>% 
  left_join(tdrmod_nodate, by = (c("year", "site", "plot_number", "treatment")))
# HOW DO I JOIN TDR AND PAR WITH NNCOVER? CHOOSE MAX PAR AND MAX TDR?
## PAR from May or July and TDR from December 
view(environ_mod)
