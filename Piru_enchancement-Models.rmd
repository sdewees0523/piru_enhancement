...
lme.tdrmod <- lmer(soil_moisture ~ treatment + mafacover + site + year + month + nncover  +(1|plot_number), 
                   data = tdrmod_nncover)
...
#Type III Analysis of Variance Table with Satterthwaite's method
#          Sum Sq Mean Sq NumDF  DenDF  F value    Pr(>F)    
#treatment   79.3    39.6     2 36.033   7.4954 0.0018977 ** 
#mafacover    2.2     2.2     1 82.716   0.4221 0.5177001    
#site        97.3    97.3     1 41.271  18.4008 0.0001053 ***
#year       182.6   182.6     1 89.715  34.5215 7.058e-08 ***
#month     3553.6  3553.6     1 68.910 671.7879 < 2.2e-16 ***
#nncover     15.7    15.7     1 89.619   2.9706 0.0882366 .  
```
...
tdrmod.treat <- lm(soil_moisture ~ treatment, data = tdrmod_nncover)
anova(tdrmod.treat)
