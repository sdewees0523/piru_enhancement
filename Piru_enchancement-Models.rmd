...
parscatter.6 <- ggplot(data = environ_mod, aes(x = mafacover, y = normalized_par, col = month)) + 
  geom_point() +
...
parscatter.7 <- ggplot(data = environ_mod, aes(x = nncover, y = normalized_par, col = month)) + 
  geom_point() +
