...
# par x treatment
parmod.treat = lm(normalized_par ~ treatment, data = parmod) 
# Extracting R-squared parameter from summary 
...
nncover_mafacover.lm <- lm(mafacover ~ nncover, data = environ_mod) 
summary(nncover_mafacover.lm)
#Residuals:
#   Min     1Q Median     3Q    Max 
#-35.03 -14.57  -3.22  11.53  47.29 

#Coefficients:
#            Estimate Std. Error t value Pr(>|t|)    
#(Intercept) 41.23873    3.04699  13.534  < 2e-16 ***
#nncover     -0.38816    0.07349  -5.282 2.54e-07 ***

#Residual standard error: 19.42 on 286 degrees of freedom
#  (36 observations deleted due to missingness)
#Multiple R-squared:  0.08888,	Adjusted R-squared:  0.08569 <-- same as...
#F-statistic:  27.9 on 1 and 286 DF,  p-value: 2.536e-07

MOD <- nncover_mafacover 
r2(MOD)
