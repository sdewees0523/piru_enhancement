...
# testing the differnce between slopes
...
```
```{r par extra stats code, include=FALSE}
...
# scatterplot: PAR x mafacover (%) x month
...
# scatterplot: PAR x nncover (%) x month
...
tdrbox <- ggplot(data = tdrmod, aes(x = site, y = soil_moisture)) +
  ...
  theme_bw() 
ggplotly(tdrbox) %>% layout(boxmode = "group")
