...
nmdsC <- metaMDS(leaftraits_nmdsprep_num, autotransform = F, trymax = 20, k = 3)
...
plot_ly(x=leaf$SLA_m2kg, y=leaf$leaf_LDMC_proportion, z=leaf$leaf_thickness_cm, type="scatter3d", mode="markers", color = leaf$species)
