...
mafa_cover_cont <- read_csv("data/mafa_cover.csv", 
    col_types = cols(cover_percent = col_double()))

mafa_cover <- mafa_cover_cont %>%
...
par_mafacover <- par %>% 
  ...
  select(year.PAR, month.PAR, plot_number, normalized_par, cover_percent) %>% 
  drop_na() 
