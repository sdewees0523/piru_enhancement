...
site_cond_may2019 <- full_join(par_may2019, tdr_march2019, by = c("site", "plot_number", "treatment", "mafacover")) %>% 
  full_join(nncover_may2018, by = c("site", "plot_number", "treatment"))
...
# mean survival by species
tapply(as.integer(height_jan_surv_may_2019$may2019_alive), 
       height_jan_surv_may_2019$species, mean)

# mean survival by site
tapply(as.integer(height_jan_surv_may_2019$may2019_alive), 
       height_jan_surv_may_2019$site, mean)

# mean survival by treatment
tapply(as.integer(height_jan_surv_may_2019$may2019_alive), 
       height_jan_surv_may_2019$treatment, mean)

# doesn't tell you much since survival is so low :/
```
...
glme.may2019.fullmod <- (glmer(as.factor(may2019_alive) ~ normalized_par + soil_moisture + site + 
                            + jan_volume_cm3 + species # plus 
                            + (1|plot_number), 
                         family = binomial, 
                         data = height_jan_surv_may_2019))
