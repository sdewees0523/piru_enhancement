...
```{r MAY 2018 - rate of change, include=FALSE}
...
#survmortnospp_jan2018 <- dplyr::filter(survmortnospp, year == "2018" & month =="1")
...
print(survmortnospp_may2018)

# left join data for May 2018 survival <---- STEPHANIE START HERE
...
```{r march 2019 - join data, include=TRUE}

survmortnospp_t1 <- dplyr::filter(survmortnospp, year == "2019" & month =="3")
par_t1 <- dplyr::filter(par, year == "2019" & month =="3")
tdr_t1 <- tdr %>% 
  dplyr::filter(year == "2019" & month =="3")
nncover_t1 <- dplyr::filter(exotic_cover_all, year == "2019")

print(nncover_t1) # each df should have 36 rows of data


# left join data for Jan-March 2019 (t1) survival
