...
#speciesRHOV                  -1.10111    0.35277  -3.121   0.0018 **
...
### E5. May 2019 post hoc by species
```{r may 2019 glmer by species CEOL, include=TRUE}
#CEOL
glme.may2019.mod.full_CEOL <- glmer(as.factor(may2019_alive) ~ normalized_par  * soil_moisture + exotic_percentcover + site + jan_volume_cm3 
                             + (1|plot_number), 
                         family = binomial(link = "logit"), 
                         data = (height_jan_surv_may_2019 %>% filter(species == "CEOL")))

MOD <- glme.may2019.mod.full_CEOL 
simulationOutput <- simulateResiduals(fittedModel = MOD, plot = T)
testDispersion(simulationOutput) # follows binomial distribution
...
#HEAR
glme.may2019.mod.full_HEAR <- glmer(as.factor(may2019_alive) ~ normalized_par  * soil_moisture + exotic_percentcover + site + jan_volume_cm3 
                             + (1|plot_number), 
                         family = binomial(link = "logit"), 
                         data = (height_jan_surv_may_2019 %>% filter(species == "HEAR")))

MOD <- glme.may2019.mod.full_HEAR 
simulationOutput <- simulateResiduals(fittedModel = MOD, plot = T)
testDispersion(simulationOutput) # follows binomial distribution

anova(glme.may2019.mod.full_HEAR)
#Analysis of Variance Table
#                             npar Sum Sq Mean Sq F value
...
summary(glme.may2019.mod.full_HEAR)
#Fixed effects:
#                              Estimate Std. Error z value Pr(>|z|)   
...
glme.may2019.mod.full_HEAR.scatter <- ggplot(data = height_jan_surv_may_2019, 
                       aes(x = normalized_par, y = may2019_alive, col = normalized_par)) +
...
```{r may 2019 glmer by species RHOV, include=TRUE}
#RHOV
glme.may2019.mod.full_RHOV <- glmer(as.factor(may2019_alive) ~ normalized_par  * soil_moisture + exotic_percentcover + site + jan_volume_cm3 
                             + (1|plot_number), 
                         family = binomial(link = "logit"), 
                         data = (height_jan_surv_may_2019 %>% filter(species == "RHOV")))

MOD <- glme.may2019.mod.full_RHOV 
simulationOutput <- simulateResiduals(fittedModel = MOD, plot = T)
testDispersion(simulationOutput) # follows binomial distribution

anova(glme.may2019.mod.full_RHOV)
#Analysis of Variance Table
#                             npar Sum Sq Mean Sq F value
...
summary(glme.may2019.mod.full_RHOV)
#Fixed effects:
#                             Estimate Std. Error z value Pr(>|z|)  
...
#SAAP
glme.may2019.mod.full_SAAP <- glmer(as.factor(may2019_alive) ~ normalized_par  * soil_moisture + exotic_percentcover + site + jan_volume_cm3 
                             + (1|plot_number), 
                         family = binomial(link = "logit"), 
                         data = (height_jan_surv_may_2019 %>% filter(species == "SAAP")))

MOD <- glme.may2019.mod.full_SAAP 
simulationOutput <- simulateResiduals(fittedModel = MOD, plot = T)
testDispersion(simulationOutput) # follows binomial distribution

anova(glme.may2019.mod.full_SAAP)
#Analysis of Variance Table
#                             npar  Sum Sq Mean Sq F value
...
summary(glme.may2019.mod.full_SAAP)
#Fixed effects:
#                             Estimate Std. Error z value Pr(>|z|)
...
# tdr March 2019 - df created from May 2019 
...
# mafacover
glme.nov2019.modcover <- glmer(as.factor(nov_alive) ~ mafacover + species + may_volume_cm3 + site + (1|plot_number), 
                         family = binomial, 
...
#may_volume_cm3        0.4490     0.2015   2.228  0.02590 * 
#speciesHEAR           1.1858     0.5644   2.101  0.03563 * 
#speciesRHOV          -0.1315     0.6460  -0.204  0.83865   
#speciesSAAP           1.6117     0.5754   2.801  0.00509 **
...
```
### F4. Nov 2019 post hoc

```{r nov 2019 post hoc, include=TRUE}
