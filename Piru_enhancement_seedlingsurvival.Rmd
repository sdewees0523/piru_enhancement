...
lme.may2018.mod <- lmer(totalsurvival ~ normalized_par + soil_moisture + exotic_percentcover + site + (1|treatment) + (1|plot), # <-- DO I NEED TO INCLUDE TREATMENT IF IT WASN'T SIG?
