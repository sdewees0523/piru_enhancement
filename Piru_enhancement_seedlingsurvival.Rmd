...
# mafacover with volume
glme.may2018.mod.mafacover <- glmer(may_alive ~ mafacover + species + march_stem_height_cm + site + (1|plot_number), 
                         family = binomial, 
...
anova(glme.may2019.mod.full_SAAP_height)
