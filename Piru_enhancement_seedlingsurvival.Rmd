...
### D1. Basic stats on seedling survival - anovas and ttests
```{r}
...
### D2. Basic stats on site - How are site 1 and site 2 different? 
...
# mafacover
glme.may2018.mod.mafacover <- glmer(may2019_alive ~ mafacover + species + volume_cm3 + site + (1|plot_number), 
                         family = binomial, 
                         data = height_jan_surv_may_2019, na.action = "na.fail")
summary(glme.may2018.mod.mafacover) # AIC = 694.6
MOD <- glme.may2018.mod.mafacover 
...
# par + tdr
glme.may2019.mod.full <- glm(as.factor(may2019_alive) ~ normalized_par + soil_moisture + exotic_percentcover + site + jan_volume_cm3 + species 
