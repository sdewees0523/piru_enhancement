...
lme.may2018.mod <- lmer(may_alive ~ normalized_par + soil_moisture + exotic_percentcover + site + (1|treatment) + (1|plot_number), 
                        data = height_march_surv_may) # <-- DO I NEED TO INCLUDE TREATMENT IF IT WASN'T SIG? 
