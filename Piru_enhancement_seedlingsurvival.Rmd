...
glme.may2018.mod <- glmer(may_alive ~ normalized_par * soil_moisture + exotic_percentcover + species + site + march_stem_height_cm + (1|plot_number),
                                family = binomial, 
                         data = height_march_surv_may) # 11 columns in df
# treatment and location cause error messages
# don't include individual because it's similar to species - blue and green are CEOL, RHOV, SAAP. R, S, C are HEAR only. 
...
# when normalized_par + soil_moisture
#Analysis of Variance Table
#                     npar  Sum Sq Mean Sq F value
#normalized_par          1  3.4936  3.4936  3.4936
#soil_moisture           1 20.6467 20.6467 20.6467
#exotic_percentcover     1  3.0132  3.0132  3.0132
#site                    1 21.6389 21.6389 21.6389
#rgr                     1  0.9211  0.9211  0.9211
#march_stem_height_cm    1  2.1179  2.1179  2.1179
#species                 3  7.9990  2.6663  2.6663

# when normalized_par * soil_moisture
#Analysis of Variance Table
#                             npar  Sum Sq Mean Sq F value
#normalized_par                  1  5.4784  5.4784  5.4784
#soil_moisture                   1 18.6115 18.6115 18.6115
#exotic_percentcover             1  3.1183  3.1183  3.1183
#site                            1 21.8896 21.8896 21.8896
#rgr                             1  0.6758  0.6758  0.6758
#march_stem_height_cm            1  2.2468  2.2468  2.2468
#species                         3  7.5882  2.5294  2.5294
#normalized_par:soil_moisture    1  5.8146  5.8146  5.8146
...
may2018.mod_interaction <- lm(may_alive ~ normalized_par*soil_moisture, data = height_march_surv_may)
anova(may2018.mod_interaction) # p-values for the interaction
