...
glimpse(height_march_surv_may_notransf)

write.csv(height_march_surv_may_notransf, "data/processed/height_march_surv_may_notransf.csv")

glimpse(height_march_surv_may_notransf %>%  # check number of individuals per plot
...
```{r may 2018 glmer SANDBOX, include=TRUE}
...
#soil_moisture                     0.40087    0.15856   2.528   0.0115 *  
...
#speciesHEAR                       1.08268    0.51634   2.097   0.0360 *  
#speciesRHOV                       1.04482    0.70018   1.492   0.1356    
#speciesSAAP                      -0.09353    0.56593  -0.165   0.8687    
#normalized_par:soil_moisture      0.55959    0.14347   3.901  9.6e-05 ***
...
glme.may2018.mod <- glmer(as.factor(height_march_surv_may$may_alive) ~ # not normally distributed because bimodal 
                         ...
                         + species
                          + (1|plot_number) + (1|treatment), # don't add right/left or individual code (blue, green, )
